...
struct Converter<atom::WebContentsZoomController::ZoomDirection> {
  static v8::Local<v8::Value> ToV8(
    ...
    switch (val) {
      case ZoomDirection::ZOOM_DIRECTION_IN:
        direction = "in";
        break;
      case ZoomDirection::ZOOM_DIRECTION_OUT:
        direction = "out";
        break;
      default:
        break;
...
void WebContents::ContentsZoomChange(bool zoom_in) {
  const atom::WebContentsZoomController::ZoomDirection zoom_direction =
      zoom_in
          ? atom::WebContentsZoomController::ZoomDirection::ZOOM_DIRECTION_IN
          : atom::WebContentsZoomController::ZoomDirection::ZOOM_DIRECTION_OUT;
